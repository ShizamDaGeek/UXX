...
GLTexture* Renderer::GetOrLoadTexture(const std::string& path)
{
...
// |=====================================================
// |---[Shared draw paths to avoid repetation]-----------
// |=====================================================
void Renderer::DrawQuad(Rect rect, Color color, GLTexture* tex)
{
    shader->Use();
...
// |---[Begin and End Panel]-----------------------------
// |=====================================================
void Renderer::BeginUXXPanel(Rect PanelRect, Color PanelColor)
{
    panelOpen = true;
...
// |---[Common UI stuff]---------------------------------
// |=====================================================
void Renderer::DrawUXXButton(Rect ButtonRect, Color ButtonColor, std::string ButtonImagePath)
{
    if (!panelOpen) return;

    GLTexture* tex = ButtonImagePath.empty() ? nullptr : GetOrLoadTexture(ButtonImagePath);
    DrawQuad(ButtonRect, ButtonColor, tex);
}
void Renderer::DrawUXXSlider(Rect SliderRect, Color SliderColor)
{

}
void Renderer::DrawUXXSwitch(Rect SwitchRect, Color SwitchColor)
{
...
// |---[Advanced UI stuff]-------------------------------
// |=====================================================
void Renderer::DrawUXXImage(Rect ImageRect, Color ImageColor, std::string ImagePath)
{
    if (!panelOpen)
        return;
